...
namespace AssetBundles
{
    ...
    public class AssetBundleLoadLevelSimulationOperation : AssetBundleLoadOperation
    {
        ...
        {
            string[] levelPaths = UnityEditor.AssetDatabase.GetAssetPathsFromAssetBundleAndAssetName(assetBundleName,
                levelName);
    ...
    public class AssetBundleLoadBundleOperation : AssetBundleLoadOperation
    {
        protected string m_AssetBundleName;
        protected string m_DownloadingError;
        protected LoadedAssetBundle m_Request = null;
        ...
        public override bool Update()
        {
            ...
            m_Request = AssetBundleManager.GetLoadedAssetBundle(m_AssetBundleName, out m_DownloadingError);
            if (m_Request != null)
            {
                return false;
            }
        ...
        public override bool IsDone()
        {
            ...
            return m_Request != null && m_Request.m_AssetBundle!=null;
        }

        public LoadedAssetBundle GetLoadedBundle()
        {
            return m_Request;
        }
    }
